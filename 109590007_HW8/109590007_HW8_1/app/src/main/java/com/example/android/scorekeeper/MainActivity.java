...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int mScore1;
    private int mScore2;
    private static final int battay0=0;
    private static final int battay1=1;
    private static final int battay2=2;
    private static final int battay3=3;
    private static final int battay4=4;
    private static final int battay5=5;
    private static final int battay6=6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imPhoto = (ImageView) findViewById(R.id.Battay);
