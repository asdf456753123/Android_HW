...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 3; i++) {
            if(i == 0){
                mWordList.addLast("Hot pot");
                mWordList2.addLast("The flavorful many people eat in taiwan");
            }
            else if (i == 1) {
                mWordList.addLast("I am pasta");
                mWordList2.addLast("A restaurant where college students often eat.");
            }
            else{
                mWordList.addLast("fried noodles");
                mWordList2.addLast("a lot of people like to eat.");
            }
        }
